    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative'>
      ...
      <div className='z-10'>
        ...
        <p className='text-[#ADB7BE m-4 max-w-md]'>
          {""}
          I&rsquo;m currently working on new opportunities, my inbox is always open.
        ...
        <form className='flex flex-col' onSubmit={handleSubmit}>
          <div className='mb-6'>
            ...
            name='email'
              ...
              id='email' 
              required 
              className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 txt-sm rounded-lg block w-full p-2.5 '
